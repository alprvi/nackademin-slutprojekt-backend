...
const products = [
  ...
  new Product({
    ...
    category: "board",
    longDesc:
      "Axle crailtap fastplant dude regular footed helipop impossible. Wax Jimmy'Z half-flip transfer nollie launch ramp mongo egg plant. Pogo slap maxwell g-turn boneless risers blunt nose slide.",
    imgFile: "skateboard-generic.png",
  }),
  new Product({
    title: "Hiphop",
...
function exit() {
  console.log(`${process.env.ENVIRONMENT} DB is now seeded with products`);
  db.disconnectDB();
}
